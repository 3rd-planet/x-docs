...
;(self.webpackChunkx_docs_new = self.webpackChunkx_docs_new || []).push([
    [817],
    {
        1706: (e, t, a) => {
            ...
            const h = { breadcrumbHomeIcon: "breadcrumbHomeIcon_BZAf" }
            function b() {
                const e = (0, d.Z)("/")
                return r.createElement(
                    "li",
            ...
            const v = { breadcrumbsContainer: "breadcrumbsContainer__9vB" }
            function g(e) {
            ...
            function p(e) {
                let { children: t, active: a, index: l, addMicrodata: c } = e
                return r.createElement(
                    "li",
                    (0, n.Z)(
                        {},
                        ...
                        { className: (0, i.Z)("breadcrumbs__item", { "breadcrumbs__item--active": a }) }
                    ),
                    t,
            ...
            function E() {
                ...
                return e
                    ? r.createElement(
                          "nav",
                          {
                              className: (0, i.Z)(l.k.docs.docBreadcrumbs, v.breadcrumbsContainer),
                              "aria-label": (0, m.I)({
        ...
        8894: (e, t, a) => {
            ...
            var n = a(9496),
                ...
                m = a(5661)
            const d = {
                cardContainer: "cardContainer_tQex",
                cardTitle: "cardTitle_hu9C",
                cardDescription: "cardDescription_juVL"
            }
            function u(e) {
                let { href: t, children: a } = e
                return n.createElement(
                    s.Z,
                    { href: t, className: (0, c.Z)("card padding--lg", d.cardContainer) },
                    a
                )
            }
            function h(e) {
                ...
                return n.createElement(
                    ...
                    n.createElement(
                        "h2",
                        { className: (0, c.Z)("text--truncate", d.cardTitle), title: r },
                        a,
                        " ",
                        r
                    ),
                    i &&
                        n.createElement(
                            "p",
                            { className: (0, c.Z)("text--truncate", d.cardDescription), title: i },
                            i
                        )
                )
            }
            ...
            var f = a(91),
                ...
                _ = a(1706),
                k = a(6350)
            const L = { generatedIndexPage: "generatedIndexPage_rCMg", list: "list_e_D3", title: "title_D2ur" }
            function T(e) {
            ...
            function x(e) {
                ...
                return n.createElement(
                    ...
                    n.createElement(
                        "header",
                        null,
                        n.createElement(k.Z, { as: "h1", className: L.title }, t.title),
                        t.description && n.createElement("p", null, t.description)
                    ),
                    n.createElement(
                        "article",
                        { className: "margin-top--lg" },
                        n.createElement(E, { items: a.items, className: L.list })
                    ),
                    n.createElement(
                        "footer",
                        { className: "margin-top--lg" },
            ...
            function y(e) {
                return n.createElement(n.Fragment, null, n.createElement(T, e), n.createElement(x, e))
            }
        },
        91: (e, t, a) => {
            a.d(t, { Z: () => o })
        ...
        1188: (e, t, a) => {
            ...
            function v(e) {
                ...
                const {
                    ...
                    { latestDocSuggestion: u, latestVersionSuggestion: v } = (0, s.Jo)(c),
                ...
                return n.createElement(
                    ...
                    n.createElement("div", null, n.createElement(h, { siteTitle: l, versionMetadata: a })),
                    n.createElement(
                        "div",
                        { className: "margin-top--md" },
                        n.createElement(b, { versionLabel: v.label, to: g.path, onClick: () => d(v.name) })
                    )
                )
            }
            function g(e) {
        ...
        6350: (e, t, a) => {
            ...
            function m(e) {
                ...
                if ("h1" === t || !a) return r.createElement(t, (0, n.Z)({}, m, { id: void 0 }))
                const u = (0, l.I)(
                    {
