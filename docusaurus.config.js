        ...
        [
            ...
            ({
                docs: {
                    ...
                    editUrl:
                        'https://github.com/3rd-planet/x-docs/blob/main/',
                },
                blog: {
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        ({
            ...
            metadata: [
                ...
                {name: 'description', content: 'Framework x is all about substance over style! 3rd Planet\'s Framework X is like a well-oiled machine for API development, powered by Node.js and Express'},
            ],
